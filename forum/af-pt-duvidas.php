                        ...
                        <div class="row">
                            <div class="col s12">
                                <div class="row path_top">
                                    <span><i class="small material-icons"><a class="black-text" href="forum-index.php">home</a></i> &nbsp; > <a href="af-categorias-pt.php"> Português </a> > <a href="af-pt-duvidas.php"> Dúvidas </a> </span>
                                </div>
                        ...
                        <div class="row">
                           <table class="striped bordered">
                               <thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td> <a class="" href="af-pt-duvidas-conteudo.php"> &nbsp; Conteúdo 1 </a></td> 
