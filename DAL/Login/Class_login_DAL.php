<?php 
    ...
    {//1      
        ...
        {//2
            ...
            //cria a querry
            $sql = "SELECT TBP.tipo, TBU.usernick, TBU.pessoa, TBP.sexo, TBP.Data_de_nascimento, TBP.nome, TBP.foto FROM TB_Usuario AS TBU, TB_Pessoa AS TBP WHERE TBU.email = '$email' && TBU.senha = md5('$senha') && TBU.pessoa = TBP.cod_pessoa LIMIT 1";
